...
if __name__ == "__main__":
    print("🚀 EORA AI 간단한 홈페이지 서버 시작...")
    print("📍 접속 주소: http://127.0.0.1:8003")
    print("🔐 로그인: http://127.0.0.1:8003/login")
    print("⚙️ 관리자: http://127.0.0.1:8003/admin")
    print("💬 채팅: http://127.0.0.1:8003/chat")
    print("🧪 테스트: http://127.0.0.1:8003/test")
    print("=" * 50)
