...
app = FastAPI(title="EORA AI Port 8002 Server")
...
async def api_status():
    ...
    return {
        "status": "success",
        "message": "포트 8002 서버가 정상 작동 중입니다",
...
if __name__ == "__main__":
    print("🚀 EORA AI 포트 8002 서버 시작...")
    print("📍 접속 주소: http://127.0.0.1:8002")
    print("📊 API 상태: http://127.0.0.1:8002/api/status")
    print("🧪 테스트: http://127.0.0.1:8002/test")
    print("❤️ 헬스 체크: http://127.0.0.1:8002/health")
    print("=" * 50)
