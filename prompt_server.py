...
# FastAPI 앱 생성
app = FastAPI(title="EORA AI 프롬프트 서버")
...
if __name__ == "__main__":
    print("\n" + "="*50)
    print("🚀 EORA AI 프롬프트 관리 서버")
    print("="*50)
    print(f"📍 홈페이지: http://127.0.0.1:8030")
    print(f"🔐 로그인: http://127.0.0.1:8030/login")
    print(f"⚙️ 관리자: http://127.0.0.1:8030/admin")
    print(f"📝 프롬프트 관리: http://127.0.0.1:8030/prompt_management")
    print("="*50)
    print("📧 관리자: admin@eora.ai / 비밀번호: admin123")
    print("📧 테스트: test@eora.ai / 비밀번호: test123")
    print("="*50)
    print(f"📄 프롬프트 파일: {prompts_file_path}")
    print(f"🔢 로드된 AI: {len(prompts_data)}개")
    print("="*50)
